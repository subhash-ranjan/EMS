...
import { postDesignation } from 'src/actions/employee'
...
class add extends React.Component {
            ...
            <SafeAreaView style={styleThis.main}>
                ...
                <KeyboardAvoidingView
                    ...
                    <View style={styleThis.input}>
                        ...
                        />
                        {this.state.nameError && <Text style={styleThis.txtError}>Enter designation name</Text>}
                    </View>
                    <View style={styleThis.input}>
                        ...
                        <Button
                            ...
                            style={{ ...Common.button }}
                            onPress={() => this.submitDesignation()}>
                            Submit
                    </Button>
                    </View>
                </KeyboardAvoidingView>
    ...
    submitDesignation() {
        if (this.state.name == '') {
            ...
            this.props.postDesignation(objRequest, this.state.mode)
        }
    }
    componentDidMount() {
        if (this.state.isSuccessShow)
...
function mapDispatchToProps(dispatch) {
    return {
        postDesignation: (objRequest, mode) => dispatch(postDesignation(objRequest, 0, mode))
    }
}
